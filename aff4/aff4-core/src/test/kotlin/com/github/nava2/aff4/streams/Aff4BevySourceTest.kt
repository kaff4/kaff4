...
class Aff4BevySourceTest {
  ...
  private lateinit var bevy: Bevy
  private lateinit var bevyIndexReader: BevyIndexReader
  ...
  fun setup() {
    ...
    bevy = bevyFactory.create(imageStreamIri, 0)
    bevyIndexReader = BevyIndexReader(aff4Model.imageRootFileSystem, imageStreamConfig, bevy)
